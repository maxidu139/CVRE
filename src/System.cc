...
void System::SaveAtlas(int type){
    if(!mStrSaveAtlasToFile.empty())
    {
        ...
        pathSaveFileName = pathSaveFileName.append(".bin");
...
bool System::LoadAtlas(int type)
{
    ...
    pathLoadFileName = pathLoadFileName.append(".bin");
    ...
    if(type == TEXT_FILE) // File text
    {
        ...
        cout << "System.cc Linea 1472" << endl;
        Atlas mpAtlas;
        cout << "System.cc Linea 1474" << endl;
        ia >> mpAtlas;
        cout << "System.cc Linea 1475" << endl;
        ia >> strFileVoc;
        ia >> strVocChecksum;
